...
namespace CMSM.Common
{
	...
	public class LogAdapter
	{
        ...
        {
            // 组装路径
            strDatabaseExPath  = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("DatabaseExLogPath");
            strBusinessExPath  = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("BusinessExLogPath");
            strFeaturesExPath  = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("FeaturesExLogPath");
			strInterfaceExPath = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("InterfaceExLogPath");
			strCustomLogPath   = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("CustomLogPath");
			strServiceLogPath  = AppDomain.CurrentDomain.BaseDirectory + "log/";//ConfigAdapter.GetConfigNote("ServiceLogPath");
        }
