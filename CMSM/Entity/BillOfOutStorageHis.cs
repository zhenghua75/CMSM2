...
namespace CMSM.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbBillOfOutStorageHis")]
	public class BillOfOutStorageHis: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public BillOfOutStorageHis():base()
		{
		}
		
		public BillOfOutStorageHis(DataRow row):base(row)
		{
		}
		
		public BillOfOutStorageHis(DataTable table):base(table)
		{
		}
		
		public BillOfOutStorageHis(string  strXML):base(strXML)
		{
		}
		#endregion
