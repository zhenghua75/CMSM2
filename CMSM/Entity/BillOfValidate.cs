...
namespace CMSM.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbBillOfValidate")]
	public class BillOfValidate: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public BillOfValidate():base()
		{
		}
		
		public BillOfValidate(DataRow row):base(row)
		{
		}
		
		public BillOfValidate(DataTable table):base(table)
		{
		}
		
		public BillOfValidate(string  strXML):base(strXML)
		{
		}
		#endregion
