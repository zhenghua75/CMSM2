...
namespace CMSM.CMSMApp
{
	...
	public class frmAssCons : CMSM.CMSMApp.frmBase
	{
		...
		private void InitializeComponent()
		{
			...
			this.sbtnRead.Location = new System.Drawing.Point(152, 24);
			...
			this.lblerr.Location = new System.Drawing.Point(0, 24);
			this.lblerr.Name = "lblerr";
			this.lblerr.Size = new System.Drawing.Size(688, 72);
...
//			chs.strCardID="00932";
			...
			if(mebres!=null)
			{
				...
				{
					string  aa=comp1.strPrepayBalance;
					MessageBox.Show("当前余额不足，不能消费！余额为： " + comp1.strPrepayBalance + "元 ","系统提示",System.Windows.Forms.MessageBoxButtons.OK,System.Windows.Forms.MessageBoxIcon.Error);
					return;
				}
				else
				{
				...
				this.cmbGoodsName.SelectedIndex=cmbGoodsName.FindString(mebres.strGoodsName);
				this.cmbGoodsType.SelectedIndex=cmbGoodsType.FindString(mebres.strGoodsType);
				...
				if(cmbGoodsName.Text.Trim()!=""&&cmbGoodsType.Text.Trim()!=""&&cmbUnit.Text.Trim()!="")
				{
					...
					txtPrice.Text=acp.strPrice;
					txtDensity.Text=acp.strDensity;
					...
					{
						txtCurStorage.Text=(Math.Round((double.Parse(acp.strCurStorageCount)/double.Parse(acp.strDensity)),2)).ToString();
					}
...
//			}
			...
			err=null;
			string strSerialok="";
			if(cs.AssCons(cis,out err,out strSerialok))
			{
				MessageBox.Show("结帐成功！请核对消费数量和油号，如有错误，请及时撤销！如有再次消费，此笔消费将不能更改！","系统提示",System.Windows.Forms.MessageBoxButtons.OK,System.Windows.Forms.MessageBoxIcon.Information);
				if(strSerialok=="")
				{
		...
		private void sbtnAdd_Click(object sender, System.EventArgs e)
		{
			...
			err=null;
			double dKgCount=Math.Round(dCount*double.Parse(txtDensity.Text.Trim()),2);
